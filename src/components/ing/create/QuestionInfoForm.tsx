  ...
  return (
    <div className="w-full h-screen relative">
      ...
      <div className="w-full mb-7 px-5">
        <label
          className="block text-lg tracking-tighter leading-tight font-pretendard-200 text-black/80 text-left mb-3"
          htmlFor="eventName"
        >
          질문을 받고 싶은 시간을 입력해주세요.
        </label>
        <input
      ...
      <div className="w-full mb-7 px-5">
        <label
          className="block text-lg tracking-tighter leading-tight font-pretendard-200 text-black/80 text-left mb-[10px]"
          htmlFor="eventName"
        >
          질문 개수를 설정해주세요.
        </label>
        <div className="flex flex-row items-center gap-1 pl-1">
          <div className="text-xl tracking-tighter leading-tight font-pretendard-300 text-black/60">
            {eventInfo.questionSize + '개'}
          </div>
          <div className="text-base tracking-tighter leading-tight font-pretendard-200 text-black/60">
