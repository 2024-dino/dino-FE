  ...
  return (
    <div className="mt-[50px] w-full">
      {events.map((event) => (
        ...
        >
          {/* title */}
          <div className="w-[calc(100%-60px)] h-[20px] mb-[8px]">
          ...
          <div
            className="w-[calc(100%-40px)] h-[80px] mb-[20px] rounded-[10px] bg-white"
          ...
          >
            <div className="w-full h-[80px] flex flex-col items-center justify-center px-[10px]">
              <div className="w-full items-center flex h-[33px]">
              ...
              <div className="w-full flex items-center h-[33px]">
                <span className="font-pretendard-300 text-[#BAD7EC] text-[24px]">
                  A.
                </span>
                <span className="ml-[10px] font-pretendard-200 text-[14px]">
